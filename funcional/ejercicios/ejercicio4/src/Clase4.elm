...
sumarArbol arbol =
    case arbol of
        Empty -> 0
        Node valor izq der -> (max (sumarArbol izq) + (sumarArbol der)) + valor
    ...
    case arbol of
        ...
        Node v izq der ->
            case ((encontrarMinimo izq), (encontrarMinimo der)) of
                ...
                (Nothing, Just minDer) -> Just (min v midDer)
    ...
    case arbol of
        ...
        Node v izq der ->
            case ((encontrarMaximo izq), (encontrarMaximo der)) of
                (Nothing, Nothing) -> Just v
                (Just maxIzq, Nothing) -> Just (max v minIzq)
                (Nothing, Just maxDer) -> Just (max v midDer)
                (Just maxIzq, Just maxDer) -> Just (max v (max minIzq minDer))
